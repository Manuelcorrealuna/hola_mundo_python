...
# print(....)
print("El valor del primer número entero a operar es", numero_1), 
print("El valor del segundo número entero a operar es", numero_2)
...
print("El valor de división es", división)
print("El valor de Multiplicación es", multiplicación)
